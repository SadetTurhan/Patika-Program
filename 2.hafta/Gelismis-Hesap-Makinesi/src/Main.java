...
public class Main {
    ...
    static void modAlma(){
        ...
        int a = input.nextInt();
        System.out.println("Hangi sayıya kalanını almak istiyorsunuz? ");
        int b = input.nextInt();
    ...
    static void triangleArea(){
        ...
        int dikdortgenCevre = (kisaKenar * 2 ) + (uzunKenar * 2 );
        System.out.println("Dikdörtgenin alanı :" + dikdortgenAlani);
